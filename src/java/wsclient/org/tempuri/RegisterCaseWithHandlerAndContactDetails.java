 ...
 *         &lt;element name="handlerGuid" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="handlerGroupGuid" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "RegisterCaseWithHandlerAndContactDetails")
public class RegisterCaseWithHandlerAndContactDetails {
    ...
    @XmlElementRef(name = "handlerGuid", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<String> handlerGuid;
    @XmlElementRef(name = "handlerGroupGuid", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<String> handlerGroupGuid;
    ...
    /**
     * Gets the value of the handlerGuid property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getHandlerGuid() {
        return handlerGuid;
    }

    /**
     * Sets the value of the handlerGuid property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setHandlerGuid(JAXBElement<String> value) {
        this.handlerGuid = ((JAXBElement<String> ) value);
    }

    /**
     * Gets the value of the handlerGroupGuid property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getHandlerGroupGuid() {
        return handlerGroupGuid;
    }

    /**
     * Sets the value of the handlerGroupGuid property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setHandlerGroupGuid(JAXBElement<String> value) {
        this.handlerGroupGuid = ((JAXBElement<String> ) value);
    }
