 ...
 *         &lt;element name="uniqueFormId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "DeleteTempForm")
public class DeleteTempForm {
    ...
    @XmlElementRef(name = "uniqueFormId", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<String> uniqueFormId;
    ...
    /**
     * Gets the value of the uniqueFormId property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<String> getUniqueFormId() {
        return uniqueFormId;
    }

    /**
     * Sets the value of the uniqueFormId property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setUniqueFormId(JAXBElement<String> value) {
        this.uniqueFormId = ((JAXBElement<String> ) value);
    }
